...
function setup() {
  ...
  box1 = createSprite(30,random(50,680), random(30,100), random(30,100))
 box2 = createSprite(1280,0,  random(30,100),random(30,100))
   box3 = createSprite(random(0,1280),525,  random(30,200),random(30,100))
   box4 = createSprite(random(0,1280),525, random(30,100),random(30,100))
   box5 = createSprite(random(0,1280),525,  random(30,200),random(30,100))
   box6 = createSprite(random(0,1280),525, random(30,100),random(30,100))
  box4.visible=false
  box3.visible=false
  box2.visible=false
  box1.visible=false
...
function draw() {
  ...
  stroke(0,90)
  stroke("black")
  text("press control+r if you die",600,250)
